...
class OperationPipeline:
    def __init__(
        ...
        *,
        ...
        activity_callback: Callable[[SandboxRef], Awaitable[None]] | None = None,
    ) -> None:
    ...
    async def _run(
        ...
        *,
        ...
        try:
            ...
            if self._activity_callback is not None and sandbox_ref is not None:
                await self._activity_callback(sandbox_ref)
