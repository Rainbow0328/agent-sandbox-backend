...
class SandboxBackend:
    ...
    async def _renew_after_activity(self, ref: SandboxRef) -> None:
        if self._sandbox_ttl_seconds is None:
            return
        await self.provider.renew_expiration(ref, self._sandbox_ttl_seconds)
